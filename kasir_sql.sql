...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2025 at 08:38 AM
...
(7, '123', 'Jl. Paus Berenang 123', '123'),
(99, 'Pembeli Barang', 'Jl. awdknawd', '0846746');
...
(13, 'White Monster Energy Drink', 54000.00, 23);

-- --------------------------------------------------------

--
-- Table structure for table `staff_kasir`
--

CREATE TABLE `staff_kasir` (
...
--
-- Dumping data for table `staff_kasir`
--

INSERT INTO `staff_kasir` (`user_id`, `username`, `password`, `peran`) VALUES
(1, 'admin', '$2y$10$qFla2uUXkObv6qUMF43TseSOIw8zWRhQ.kls9bQUCObHDmKbT3Ufi', 'administrator'),
(2, 'petugas', '$2y$10$5E6e./6C5JkNGqDg0L.65um/B52SLn7LpXr3ssY04erHAlElTxCWS', 'petugas');
...
--
-- Indexes for table `staff_kasir`
--
ALTER TABLE `staff_kasir`
...
--
ALTER TABLE `pelanggan`
  MODIFY `PelangganID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
...
--
-- AUTO_INCREMENT for table `staff_kasir`
--
ALTER TABLE `staff_kasir`
